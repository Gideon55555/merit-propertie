...
export default function FloorTabs({ activeTab, setActiveTab, tabs }: FloorTabsProps) {
  return (
            ...
            >
              ...
              <span
                className={`text-lg md:text-xl font-primary font-bold transition-colors duration-300 ${
                  isActive ? "text-merit-gold" : "text-white/60 group-hover:text-white"
                }`}
              >
                {tab.shortName}
              </span>
              ...
              <span
                className={`text-xxs md:text-xs tracking-wider uppercase font-secondary font-light transition-colors duration-300 mt-0.5 ${
                  isActive ? "text-merit-gold/80" : "text-white/40 group-hover:text-white/70"
                }`}
              >
                {tab.shortName === "SB" || tab.shortName === "LG" || tab.shortName === "UG"
