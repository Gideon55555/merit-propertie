        ...
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            <h1 className="text-5xl md:text-7xl font-primary text-white leading-tight mb-6">
              Prime <span className="text-merit-gold">Locations</span>
            </h1>
          </motion.div>
          ...
          <motion.div
            ...
            <p className="text-xl md:text-2xl font-secondary text-white/90 mb-8 leading-relaxed">
              Discover our strategically positioned properties in the most
              sought-after areas of Addis Ababa, offering unparalleled
