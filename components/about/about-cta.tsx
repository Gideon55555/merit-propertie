          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-12 lg:p-16 flex flex-col justify-center">
              ...
              <p className="font-secondary text-white/80 mb-8 max-w-lg">
                Whether you&apos;re looking for a new home, a commercial space,
                or an investment opportunity, Merit Real Estate has the perfect
            ...
            <Image
              src="/images/design/image-00097.png"
              height={500}
              width={500}
